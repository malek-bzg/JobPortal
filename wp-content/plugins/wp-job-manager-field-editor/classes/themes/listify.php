...
class WP_Job_Manager_Field_Editor_Themes_Listify {
	...
	public $card_actions;
	public static $COMPAT_GIT_COMMIT = "aeYGfFTPwRN6TRoiWoNmtQEE";
	 ...
	 */
	function custom_css(){
		echo '<style>.job-manager-term-checklist ul.children > li { list-style: none;width: 100%; } .jmfe-logic-hide { display: none !important; }</style>';
	}
